...
injectInModel('Organization', `timetableSchedules        TimetableSchedule[]
  schoolTimetableContexts   SchoolTimetableContext[]
  tuitionTimetableContexts  TuitionTimetableContext[]
  timetableEntries          TimetableEntry[]`);

injectInModel('Branch', `timetableSchedules TimetableSchedule[]`);
injectInModel('Section', `schoolTimetableContexts SchoolTimetableContext[]`);
injectInModel('Batch', `tuitionTimetableContexts TuitionTimetableContext[]`);
injectInModel('SubjectOffering', `timetableEntries TimetableEntry[]`);
injectInModel('TeachingAssignment', `timetableEntries TimetableEntry[]`);
