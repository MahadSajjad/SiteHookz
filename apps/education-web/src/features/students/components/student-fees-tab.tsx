    ...
    <div className="p-4 space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-semibold">
          {t("finance.financialSummary", "Financial Summary")}
        </h2>
        <div className="space-x-2">
          <button className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded">
            {t("finance.assignFeePlan", "Assign Fee Plan")}
          </button>
          <button className="bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded">
            {t("finance.generateFee", "Generate Monthly Fee")}
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <p className="text-sm text-gray-500">
            {t("finance.totalCharges", "Total Charges")}
          </p>
