...
export default function FeePlansList() {
  const { t } = useTranslation();

  const data = [
    { id: "1", name: "Grade 1 Annual Plan", type: "SCHOOL", totalAmount: 1200, status: "ACTIVE" },
  ];

  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">{t("finance.feePlans", "Fee Plans")}</h1>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{t("finance.totalAmount", "Total Amount")}</th>
