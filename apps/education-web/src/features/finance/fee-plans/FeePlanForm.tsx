  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">
        {t("common.create", "Create")} {t("finance.feePlans", "Fee Plans")}
      </h1>
      ...
      <form className="space-y-6">
        ...
        {type === "SCHOOL" && (
          <div>
            <label className="block text-sm font-medium text-gray-700">
              {t("academics.classLevel", "Class Level")}
            </label>
        ...
        <div>
          ...
          <div className="mt-2 flex space-x-2">
            ...
            <input
              ...
              className="block w-32 border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
            />
            <button
              type="button"
