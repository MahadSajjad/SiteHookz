...
export function BatchTimetablesTab({ batchId }: { batchId: string }) {
  ...
  const { data: schedules, isLoading: isLoadingSchedules } = useQuery({
    queryKey: ["education.timetables.tuition", batchId],
    queryFn: () => api.timetables.listTuitionTimetables(batchId),
    enabled: !!batchId,
  });
  ...
  const { data: subjectOfferings } = useQuery({
    queryKey: ["education.subjectOfferings.list", { batchId }],
    queryFn: () => api.subjectOfferings.getByBatchId(batchId),
    enabled: !!batchId,
  });

  const createMutation = useMutation({
    mutationFn: () =>
      api.timetables.createTuitionTimetable(batchId, {
        name: "New Timetable",
