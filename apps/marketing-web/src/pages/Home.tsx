    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="py-6 px-4 md:px-8 max-w-7xl mx-auto flex justify-between items-center">
        ...
        <nav className="space-x-4">
          <a
            href="http://app.sitehookz.localhost/login"
            className="text-muted-foreground hover:text-foreground"
          >
            Login
          </a>
          <a
            href="http://app.sitehookz.localhost/register"
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-8 py-20">
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-xl text-muted-foreground">
            Scale your institution with our powerful suite of tools. From
            education management to enterprise operations, SiteHookz has you
            covered.
          </p>
          <div className="flex justify-center gap-4 pt-8">
            ...
            <a
              href="#features"
              className="bg-surface text-foreground border border-border px-8 py-3 rounded-md font-medium text-lg hover:bg-surface-secondary transition-colors"
            >
              View Products
            </a>
          </div>
        ...
        >
          <div className="bg-surface border border-border p-8 rounded-lg shadow-sm">
            ...
            <p className="text-muted-foreground">
              A comprehensive learning management system tailored for modern
              institutions. Manage courses, students, and grades all in one
              place.
            </p>
          </div>
