...
export class ClassLevelsService {
  ...
  async create(tenant: TenantContext, dto: any) {
    if (tenant['institutionType' as any] /* TEMP: TenantContext should include institutionType */ !== 'SCHOOL') throw new BadRequestException('EDUCATION_INSTITUTION_TYPE_MISMATCH');
