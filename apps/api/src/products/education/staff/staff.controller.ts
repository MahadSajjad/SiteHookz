...
export class StaffController {
  ...
  async findOne(
    ...
    return this.staffService.findOne(tenant, id);
  }
  ...
  async create(
    @CurrentTenant() tenant: TenantContext,
    @Body(new ZodValidationPipe(createStaffSchema)) dto: any,
  ) {
    return this.staffService.create(tenant, dto);
  }

  @Get("staff-positions")
  @RequirePermission("education.staff_positions.read")
  async findPositions(@CurrentTenant() tenant: TenantContext) {
    return this.staffService.findPositions(tenant);
  }
  ...
  async createPosition(
    @CurrentTenant() tenant: TenantContext,
    @Body(new ZodValidationPipe(createPositionSchema)) dto: any,
  ) {
    return this.staffService.createPosition(tenant, dto);
  }
  ...
  async getAssignments(
    ...
    return this.staffService.getAssignments(tenant, staffId);
  }
  ...
  async createAssignment(
    @CurrentTenant() tenant: TenantContext,
    @Param("staffId") staffId: string,
    @Body(new ZodValidationPipe(assignBranchSchema)) dto: any,
  ) {
    return this.staffService.createAssignment(tenant, staffId, dto);
  }
  ...
  async endAssignment(
    ...
    return this.staffService.endAssignment(tenant, staffId, assignmentId);
  }
}
